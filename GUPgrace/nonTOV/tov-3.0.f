...
C             WRITE(1,*)(XP/1.D3),PRESS,MASST
C      &      ,(ALPHA-0.5D0*LOG(1.D0-2.D0*GS*MSS*MASST/XP))
C      &      ,LAMBDA*1.D-6
C      &      ,(EDEN/1.D3),(SIGMA*1.D0)
            WRITE(1,*) XP,EXP(2*ALPHA),PRESS,MASST,LAMBDA
     &      ,(1.D0-2.D0*GS*MSS*MASST/XP)
      ENDIF
...
C       DPT=1.D0/DEDP(PRESS)          ! ISO
      ...
      DSDE=1.D0/DEDP(PRESS)-DPT       !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  mestinya - bukan +
...
c     function speed of sound squared (analytical derivative tangential  pressure respect to eden)    
      ...
      DPTDE=W-0.5D0*ALPHA/DSQRT(ED-BagCT)
