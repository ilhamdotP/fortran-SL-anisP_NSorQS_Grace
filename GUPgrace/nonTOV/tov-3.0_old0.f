...
C        WRITE(*,*) IL
       ...
       ! Ptes2=PCC*1.01D0
       ! Etes1=FED(PCC)
       ! Etes2=FED(PCC*1.01D0)
       ! tes1=SIG(Ptes1,Etes1,PCC,EDC)
       ! tes2=SIG(Ptes2,Etes2,PCC,EDC)
       ! print*,tes1,tes2
       ! stop
...
C        SIGMA=YDY*(2.D0*GS*MSS*MASST/XA)*PRESS
     ...
     &      LAMBDA*1.D-6,(EDEN/1.D0),(SIGMA*1.D3)
      ENDIF
...
C       a4T=0.9D0
      ...
      AA=ED-BagCT
      AB=DSQRT(AA)
      DPTDE=1.0D0/3.D0-0.5D0*ALPHA/AB
     &        +0.5D0*BETA*KAPPA/AA
      RETURN
      END    
