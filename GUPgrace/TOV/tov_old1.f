...
C       a4=0.7D0
C       SQA=DSQRT(a4)
C       XXX=ms**2/(3.D0*PI*HC**(1.5D0))
C       ALPHA=XXX/(SQA)
C       BETA=XXX**2*(1.D0-1.D0/(a4))*9.D0/12.D0
C       GAMMA=8.D0/(9.D0*SQA)/XXX
C       KAPPA=3.D0/(1.D0-1.D0/(a4))
C       AA=3.D0*ALPHA**2+4.D0*(BagC+P0)
C       DEPS=1.5D0*DSQRT(3.D0)*ALPHA
C      &     *DSQRT(AA)
C      &     +4.5D0*ALPHA**2
C       AB=3.D0*(P0+BagC)+DEPS
C       AD=DLOG(GAMMA*DSQRT(AB))
C       PTD=P0
C      &     -BETA*(1.D0+KAPPA*AD)
C       AC=3.D0*ALPHA**2+4.D0*(BagC+PTD)
C       FED=1.5D0*(DSQRT(3.0D0)*
C      &     ALPHA*DSQRT(AC)+
C      &     3.D0*ALPHA**2+2.D0*(BagC+PTD))+BagC
...
C       SQAT=DSQRT(a4T)
C       XXY=ms**2/(3.D0*PI*HC**(1.5D0))
      
C       ALPHA=XXY/(SQAT)
C       BETA=XXY**2*(1.D0-1.D0/(a4T))*9.D0/12.D0
C       GAMMA=8.D0/(9.D0*SQAT)/XXY
C       KAPPA=3.D0/(1.D0-1.D0/(a4T))
      
C       AAB = ED - BagCT
C       AABA = AAB - 3.0D0*BagCT
C       SQAAB=DSQRT(AAB)
C       ALGB=DLOG(GAMMA*SQAAB)

C       AAC = EDC - BagCT
C       AACA = AAC - 3.0D0*BagCT
C       SQAAC=DSQRT(AAC)
C       ALGC=DLOG(GAMMA*SQAAC)

C       FPT=PCC+AABA/3.D0-AACA/3.D0
C      &     -ALPHA*SQAAB+ALPHA*SQAAC
C      &     +BETA*(1.D0+KAPPA*ALGB)
C      &     -BETA*(1.D0+KAPPA*ALGC)
